...
.Отображение в области "Панель инструментов"
image::ROOT:html-browser-control.png[Отображение в области "Панель инструментов"]
...
Для элемента *HTML браузер* может быть локализовано свойство *XSLT-преобразование*. Добавление локализованных названий выполняется в окне _Локализация отображаемого значения_, открываемом при нажатии на кнопку image:ROOT:buttons/globe.png[Земной шар] справа от поля.

.Добавление локализации для свойства "XSLT-преобразование"
image::ROOT:html-localize.png[Добавление локализации для свойства "XSLT-преобразование"]
